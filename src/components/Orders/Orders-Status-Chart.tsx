...
export function OrderStatusChart() {
  ...
  return (
    <Card className='grid gap-2 w-full h-full md:grid-cols-[1fr_400px] lg:grid-cols-[1fr_500px]'>
      <div className='flex flex-col'>
        ...
        <div className='flex justify-between items-start p-4 lg:px-8 gap-2 text-sm'>
